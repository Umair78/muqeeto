...
jQuery(function ($) {
    ...
    if ($('#myMap').length > 0) {
        ...
        var $latitude = 33.667563, //If you unable to find latitude and longitude of your address. Please visit http://www.latlong.net/convert-address-to-lat-long.html you can easily generate.
            $longitude = 72.997897,
        ...
        // var src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyBnvgi3Twa-6Xc7v2gayr3jw_GNaWViQew";
        var map_options = {
        ...
        var contentString = '<div id="mapcontent">' + '<p>Code Studio, Islamabad, Pakistan</p></div>';
